        ...
        <div class="row mt-5 pt-5">
            ...
            <div class="col-sm-6">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ fs_route(route('fresns.post.location', $encode)) }}">{{ fs_db_config('post_name') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ fs_route(route('fresns.comment.location', $encode)) }}">{{ fs_db_config('comment_name') }}</a>
                    </li>
                </ul>
