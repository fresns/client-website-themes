            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-center">
                            <a href="{{ route('fresns.api.content.file.link', ['fid' => $document['fid'], 'type' => 'comment', 'fsid' => $cid]) }}" data-name="{{ $document['name'] }}" data-mime="{{ $document['mime'] }}" class="btn btn-outline-success fresns-download" role="button">{{ fs_lang('contentFileDownload') }}</a>
                        </p>
                    </div>
