        ...
        @if ($fileCount['images'] == 1)
            ...
            @if (Route::is('fresns.post.detail'))
                ...
                <div class="position-relative image-box" style="width:auto;">
                    <img src="{{ $image['imageRatioUrl'] }}" data-zoom-src="{{ $image['imageBigUrl'] }}" class="img-fluid zoom-image">
                    @if ($image['imageLong'])
            ...
            @else
                ...
                @if ($image['imageLong'])
                    <div class="position-relative image-box" style="width:auto;">
                        <img src="{{ $image['imageSquareUrl'] }}" data-zoom-src="{{ $image['imageBigUrl'] }}" class="img-fluid zoom-image">
                        <span class="position-absolute bottom-0 end-0 badge bg-light text-dark me-3 mb-2">{{ fs_lang('contentImageLong') }}</span>
                    </div>
                @else
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-center">
                            <a href="{{ route('fresns.api.content.file.link', ['fid' => $document['fid'], 'type' => 'comment', 'fsid' => $cid]) }}" data-name="{{ $document['name'] }}" data-mime="{{ $document['mime'] }}" class="btn btn-outline-success fresns-file-download" role="button">{{ fs_lang('contentFileDownload') }}</a>
                        </p>
                    </div>
