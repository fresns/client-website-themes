            ...
            function t(e) {
                ...
                o(this, t),
                    ...
                    (this._triggerPointerEnd = function (t, e) {
                        ...
                        return (
                            !(n < 0) &&
                            (i.currentPointers.splice(n, 1), i.startPointers.splice(n, 1), i._endCallback(t, e), !0)
                        );
                    }),
                ...
                s(n, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            ((this.$track =
                                this.option('track') || this.$container.querySelector('.'.concat(o).concat(a.track))),
                            this.$track) ||
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                !(!this.option('infiniteX', this.option('infinite')) || this.pages.length < 2 || t < e)
                            ) {
                                var i = this.Panzoom,
                                    n = !1;
                                return (
