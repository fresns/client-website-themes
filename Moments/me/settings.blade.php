...
@section('title', fs_config('menu_account_settings'))

@php
    $languageMenus = fs_config('language_menus');
    ...
    <div class="d-lg-flex align-items-lg-start">
        <div class="nav nav-pills flex-lg-column @desktop w-25 @else border-bottom mb-4 @enddesktop" id="settings-tabs" role="tablist" aria-orientation="vertical">
            @desktop
                <div class="d-flex mx-3">
                    ...
                    <h1 class="fs-5 my-3">{{ fs_config('menu_account_settings') }}</h1>
                </div>
            @enddesktop
        ...
        <div class="tab-content border-start ps-lg-5 pb-5 account-settings px-3" id="settings-tab-content">
            ...
            <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-outline-secondary"
                        ...
                        data-desc="{{ fs_lang('settingIntervalDays') }}: {{ fs_config('username_edit') }} {{ fs_lang('modifierDays') }} | {{ fs_lang('settingLastTime') }}: {{ fs_user('detail.lastEditUsername') }}<br>{{ fs_lang('modifierLength') }}: {{ fs_config('username_min') }} - {{ fs_config('username_max') }}<br>{{ fs_lang('settingNameWarning') }}"
                        data-name="username"
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-outline-secondary"
                        ...
                        data-desc="{{ fs_lang('settingIntervalDays') }}: {{ fs_config('nickname_edit') }} {{ fs_lang('modifierDays') }} | {{ fs_lang('settingLastTime') }}: {{ fs_user('detail.lastEditNickname') }}"
                        data-name="nickname"
                        data-action="{{ route('fresns.api.user.edit') }}"
            ...
            <div class="tab-pane fade" id="interaction" role="tabpanel" aria-labelledby="interaction-tab" tabindex="0">
                ...
                {{-- Conversation --}}
                <div class="input-group mb-3">
                    <span class="input-group-text">{{ fs_config('menu_conversations') }}</span>
                    ...
                    <button class="btn btn-outline-secondary"
                        data-label="{{ fs_config('menu_conversations') }}"
                        data-type="select"
            ...
            <div class="tab-pane fade" id="account" role="tabpanel" aria-labelledby="account-tab" tabindex="0">
                ...
                {{-- Real Name --}}
                @if (fs_config('account_real_name_service'))
                    <div class="input-group mb-3">
                        ...
                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#fresnsModal"
                            ...
                            data-url="{{ fs_config('account_real_name_service') }}">
                ...
                <div class="input-group mb-3">
                    ...
                    @if (fs_config('send_sms_service'))
                        ...
                        <button class="btn btn-outline-secondary"
                            ...
                            data-type="editPhone"
                            data-name="newPhone"
                            data-sms-codes="{{ json_encode(fs_config('send_sms_supported_codes'), true) }}"
                            data-default-sms-code="{{ fs_account('detail.countryCode') ?: fs_config('send_sms_default_code') }}"
                ...
                <div class="input-group mb-3">
                    ...
                    @if (fs_config('send_email_service'))
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-outline-secondary"
                        ...
                        data-desc="{{ fs_lang('passwordInfo') }}:
                            @if (in_array('number', fs_config('password_strength'))) {{ fs_lang('passwordInfoNumbers') }} @endif
                            @if (in_array('lowercase', fs_config('password_strength'))) | {{ fs_lang('passwordInfoLowercaseLetters') }} @endif
                            @if (in_array('uppercase', fs_config('password_strength'))) | {{ fs_lang('passwordInfoUppercaseLetters') }} @endif
                            @if (in_array('symbols', fs_config('password_strength'))) | {{ fs_lang('passwordInfoSymbols') }} @endif
                            | {{ fs_lang('modifierLength') }}: {{ fs_config('password_length').'~32' }}"
