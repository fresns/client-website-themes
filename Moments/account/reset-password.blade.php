...
@section('title', fs_config('menu_account_reset_password'))
    ...
    <div class="m-lg-5 ps-lg-5 pb-lg-5" style="max-width:500px;">
        ...
        @else
            <form class="py-3" id="accordionCodeAccount" method="post" action="{{ route("fresns.api.account.reset.password")  }}">
                ...
                {{-- Phone Number --}}
                @if (fs_config('send_sms_service'))
                    <div class="collapse code_account_phone @if (old('type') == 'phone' || ! fs_config('send_email_service')) show @endif" aria-labelledby="code_account_phone" data-bs-parent="#accordionCodeAccount">
                        <div class="input-group mb-3">
