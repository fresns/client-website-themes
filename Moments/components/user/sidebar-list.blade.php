    ...
    <div class="text-start ms-2 mt-2">
        <div class="user-nickname text-nowrap overflow-hidden mt-1" style="color:{{ $user['nicknameColor'] }};">
            ...
            @if ($user['verifiedStatus'])
                ...
                @else
                    <img src="/assets/themes/Moments/images/icon-verified.png" loading="lazy" alt="Verified" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $user['verifiedDesc'] }}" height="18">
                @endif
            @endif
        </div>
