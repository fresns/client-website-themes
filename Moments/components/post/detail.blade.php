    ...
    <section class="content-main order-2 mx-3 position-relative">
        ...
        <div class="content-title d-flex flex-row bd-highlight">
            ...
            @if ($post['stickyState'] == 2)
                <img src="/assets/themes/Moments/images/icon-sticky.png" loading="lazy" alt="Group Sticky" class="ms-2">
            @elseif ($post['stickyState'] == 3)
                <img src="/assets/themes/Moments/images/icon-sticky.png" loading="lazy" alt="Global Sticky" class="ms-2">
            @endif
