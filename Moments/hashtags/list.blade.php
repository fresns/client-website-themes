...
@section('title', fs_config('channel_hashtag_list_seo')['title'])
...
@section('content')
    ...
    {{-- Hashtag List --}}
    <div class="clearfix border-top" @if (fs_config('menu_hashtag_list_query_state') != 1) id="fresns-list-container" @endif>
